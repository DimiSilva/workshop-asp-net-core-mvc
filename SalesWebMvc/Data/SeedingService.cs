...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            //Instantiate department seeds
            Department d1 = new Department(1, "Drugs");
            Department d2 = new Department(2, "Eletronics");
            Department d3 = new Department(3, "Food");
            Department d4 = new Department(4, "Cars");
            Department d5 = new Department(5, "Pets");

            //instantiate seller seeds
